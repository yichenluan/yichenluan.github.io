...
- (BOOL)isMultiForm:(NSDictionary<NSString *, id> * __nonnull)params;

/// convert the parameter dict to its HTTP string representation
- (NSString * __nonnull)stringFromParameters:(NSDictionary<NSString *, id> * __nonnull)parameters;

/// the method to serialized all the objects
- (NSArray<HTTPPair *> * __nonnull)serializeObject:(id __nonnull)object key:(NSString * __nullable)key;
- (NSData * __nonnull)dataFromParameters:(NSDictionary<NSString *, id> * __nonnull)parameters boundary:(NSString * __nonnull)boundary;
...
@interface HTTPTask : NSObject <NSURLSessionTaskDelegate, NSURLSessionDelegate>
